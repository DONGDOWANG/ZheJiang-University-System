var app = new Vue({
    ...
    data: {
        ...
        overViewList: [
            {
                src: "./images/icon/icon-overview12.png",
                title: '主建学科',
                name: '中药学，药学',
            },
            {
                src: "./images/icon/icon-overview7.png",
                title: '共建学科',
                name: '生物学',
            }, {
                src: "./images/icon/icon-overview8.png",
                title: '名誉学科带头人',
                name: '席晨湘',
            }
        ...
        subjectList2:[
            {
                src: "./images/icon/icon-overview10.png",
                title: '学术学位授予层次',
                name: '博士'
            },
            {
                src: "./images/icon/icon-overview11.png",
                title: '专业学位授予层次',
                name: '博士'
            },
    ...
    mounted: function () {
        ...
        chartCollection.lineChart1('education', this.educationList, 0, true);
